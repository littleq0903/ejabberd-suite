...
unsubscribe_node(NodeIdx, #jid{node = Usender, domain = Ssender} = Sender, Subscriber, SubId) ->
	Subjid = exmpp_jid:parse(Subscriber),
	unsubscribe_node(NodeIdx, Sender, Subjid, SubId).
